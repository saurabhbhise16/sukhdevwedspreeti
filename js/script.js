/**
 * @author sukhdeo mote <'aarjaymote@gmail.com'>
 */
(function ($) {
    "use strict";
...
var countDownDate = new Date("jul 14, 2024 15:24:00").getTime();
...
// sr.reveal(`.sukhdeo`,{ delay: 300, origin: 'top' })
sr.reveal(`.sukhdeo`, { origin: 'left', delay: 700 })
sr.reveal(`.preeti`, { origin: 'right', delay: 700 })
...
console.log('%cYour presence is requested!%c\n\nRegards: sukhdeo mote', styles1, styles2);
